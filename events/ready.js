...
//         // cyberty-ping Channel Maple Club
//         const pingChannel = client.channels.cache.get('928648058458218606')
//         const editMessage = await pingChannel.messages.fetch('928679627298308146')
//         const infoMessage = await pingChannel.messages.fetch('928679978613235803')
//         const botOwner = `Devik_NotFound#2695`
//         const cdSrt = `\`\`\`yml\n`
//         const cdEnd = `\n\`\`\``
//         const infoEmoji = `<:info:928697973947392051>`
//         setInterval( async () => {

//             const editStart = Date.now()
//             await editMessage.edit({ content: `<a:cat_weewoo:864796595689488404>` })
//             const editEnd = Date.now()

//             editMessage.edit({ content: `<a:loading:928692093256343653>` })
...
//             infoMessage.edit({ embeds: [infoEmbed] })
...
// New Code
const { onReadyChannel, botPrefix, botWebsite, supportServerLink, botInviteLink } = require('../config.json')
